          ...
          <div className="left flex-1 w-full">
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                ...
                <ProgressBar logo={<IoLogoHtml5 />} name={"Machine Learning"} value={50} />
                <ProgressBar logo={<IoLogoHtml5 />} name={"Artifical Intelligence"} value={70} />
                <ProgressBar logo={<IoLogoHtml5 />} name={"Python"} value={80} />
